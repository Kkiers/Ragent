...
## 如何获取自定义字段的元数据？
### 1.调用方式
**Step 1:** 传入`employment`和`person`调用「[获取自定义字段列表](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/query)」接口，获取自定义对象的的 API name
>
