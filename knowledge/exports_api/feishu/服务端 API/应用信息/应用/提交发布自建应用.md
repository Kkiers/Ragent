...
名称 | 类型 | 必填 | 描述
--- | --- | --- | ---
mobile_default_ability | string | 否 | 移动端默认能力  
**注意**：如果应用开启了小程序、机器人或者网页应用能力，则该参数必填。  
**示例值**："gadget"  
**可选值有**：  
- gadget：小程序  
- web_app：网页应用  
- bot：机器人
pc_default_ability | string | 否 | PC端默认能力  
**注意**：如果应用开启了小程序、机器人或者网页应用能力，则该参数必填。  
**示例值**："gadget"  
**可选值有**：  
- gadget：小程序  
- web_app：网页应用  
- bot：机器人
remark | string | 是 | 申请理由（500字符以内）  
**示例值**："更新了移动端默认应用能力"
changelog | string | 是 | 更新描述（500字符以内）  
**示例值**："更新了小程序的头像"
