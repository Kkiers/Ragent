...
名称 | 类型 | 必填 | 描述
--- | --- | --- | ---
children | block\[\] | 否 | 添加的子块列表。了解块的父子关系规则，参考[文档概述-基本概念](https://open.feishu.cn/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-overview)。在一次请求中，你最多可以创建 5 个电子表格（Sheet）块  
**数据校验规则**：  
- 长度范围：`1` ～ `50`
