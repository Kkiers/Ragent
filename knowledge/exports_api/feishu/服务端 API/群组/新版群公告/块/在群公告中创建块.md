...
component_id | string | 否 | 文档小组件 ID  
**示例值**："7056882725002051603"
component_type_id | string | 是 | 文档小组件类型，比如问答互动"blk_636a0a6657db8001c8df5488"  
...
- MessageLink：消息链接  
- Undefined：未定义的链接类型
index | int | 否 | 当前 block 在 children 中的插入位置，起始值为 0，最大值为原 children 长度  
**示例值**：0  
**默认值**：`-1`
