...
1. 登录[飞书 MCP 配置平台](https://open.feishu.cn/page/mcp)。warning
    远程 MCP Server 配置功能正在内测中，如无法访问配置平台，可在文档页面右下角联系技术支持（选择 **展开 ![1.jpeg](https://sf3-cn.feishucdn.com/obj/open-platform-opendoc/3a8c96a3a2e51904a7844aa528bef4e9_Fl5jtZzjjW.jpeg?height=118&lazyload=true&maxWidth=25&width=88) > 技术支持 ![2.jpeg](https://sf3-cn.feishucdn.com/obj/open-platform-opendoc/f4fdf13e08e57688862cc2e94e327d9f_1wOZUmukkM.jpeg?height=126&lazyload=true&maxWidth=28&width=126)**）。
...
4. 添加工具后，在 **如何使用 MCP 服务** 区域，查看 **服务器 URL、JSON**。warning
	...
	![image.png](https://sf3-cn.feishucdn.com/obj/open-platform-opendoc/46d643e6d2ef5e0e8a69742f273644ba_DIszsZcNeH.png?height=626&lazyload=true&maxWidth=400&width=1642)
...
![image.png](https://sf3-cn.feishucdn.com/obj/open-platform-opendoc/1a73ba247e10cde93b40f6856f6f42d9_nIcefqXAHP.png?height=832&lazyload=true&maxWidth=400&width=1634)
...
4. 在右侧 AI 对话框中输入提示词，即可使用飞书 MCP 服务。   
 Cursor 版本更新可能会导致工具调用截断，官方修复版正灰度发布中。  
