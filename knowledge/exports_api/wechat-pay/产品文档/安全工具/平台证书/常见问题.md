...
- “微信支付平台证书”包含微信支付平台标识、公钥信息的证书。商户可通过调用[下载平台证书接口](https://pay.weixin.qq.com/doc/v3/merchant/4012551764)或使用[平台证书下载工具](https://pay.weixin.qq.com/doc/v3/merchant/4012076524)，获取当前可用的微信支付平台证书。
...
A：商户上送敏感信息时使用了微信支付平台公钥加密。为了能使用正确的密钥解密，微信支付要求商户在请求的HTTP头部中包括证书序列号，以声明加密所用的密钥对和微信支付平台证书。详见[这里](https://pay.weixin.qq.com/doc/v3/merchant/4012365346)的说明。
...
2、如果商户需对接v3接口，建议使用[微信支付公钥方案](https://pay.weixin.qq.com/doc/v3/merchant/4012153196)，微信支付公钥和平台证书都是用于v3版本接口的验签及敏感信息加密，公钥没有有效期，便于维护。
...
A：建议除了首次下载证书通过[工具下载](https://pay.weixin.qq.com/doc/v3/merchant/4012076524)，后续下载证书请使用微信支付[平台证书下载](https://pay.weixin.qq.com/doc/v3/merchant/4012551764)接口。
...
A：是因为无可用的平台证书导致的报错，请参考指引接入[微信支付公钥方案](https://pay.weixin.qq.com/doc/v3/merchant/4012153196)，如果有疑问，请联系[在线技术支持](https://support.pay.weixin.qq.com/aidevhelper?from=wechatpaydoc)。

## Q：调用下载平台证书接口报错：{"code":"NOT_ENOUGH";"message":"平台证书已过期失效，请联系微信支付技术支持。"}，什么原因？

A：平台证书过期导致返回的证书列表为空，请参考指引接入[微信支付公钥方案](https://pay.weixin.qq.com/doc/v3/merchant/4012153196)，如果有疑问，请联系[在线技术支持](https://support.pay.weixin.qq.com/aidevhelper?from=wechatpaydoc)。
