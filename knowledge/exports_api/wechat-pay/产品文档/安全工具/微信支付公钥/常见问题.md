...
A: 平台证书的有效期为5年，即每5年，商户需要更换一次证书，如果你的系统未实现平滑切换，未能及时更换新证书则会导致接口调用异常，因此建议你从平台证书模式切换到公钥模式，可以参考[如何从平台证书切换成微信支付公钥](https://pay.weixin.qq.com/doc/v3/merchant/4012154180)完成操作
