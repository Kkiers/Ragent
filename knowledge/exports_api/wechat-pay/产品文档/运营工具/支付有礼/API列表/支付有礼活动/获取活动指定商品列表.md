...
```
1curl -X GET \
2  https://api.mch.weixin.qq.com/v3/marketing/paygiftactivity/activities/10028001/goods?offset=1&limit=20 \
...
38    );
39
40    ListActivitySkuRequest request = new ListActivitySkuRequest();
41    request.activityId = "10028001";
42    request.offset = 1L;
43    request.limit = 1L;
44    try {
45      ListActSkuResponse response = client.run(request);
46        // TODO: 请求成功，继续业务逻辑
...
52  }
53
54  public ListActSkuResponse run(ListActivitySkuRequest request) {
55    String uri = PATH;
...
93			return nil, err
94		}
95		response := &ListActSkuResponse{}
...
108}
109
110type ListActivitySkuRequest struct {
...
114}
115
116func (o *ListActivitySkuRequest) MarshalJSON() ([]byte, error) {
117	type Alias ListActivitySkuRequest
118	a := &struct {
...
131}
132
133type ListActSkuResponse struct {
134	Data       []SkuInfo `json:"data,omitempty"`
...
139}
140
141type SkuInfo struct {
142	GoodsId    *string `json:"goods_id,omitempty"`
143	CreateTime *string `json:"create_time,omitempty"`
144	UpdateTime *string `json:"update_time,omitempty"`
145}
146
```
...
| --- | --- |
|  | goods_id 　必填   string【指定商品】指定商品（商品sku）  create_time 　必填   string【创建时间】创建时间  update_time 　必填   string【更新时间】更新时间 |
...
3    {
4      "goods_id" : "0345678",
5      "create_time" : "2015-05-20T13:29:35.120+08:00",
6      "update_time" : "2015-05-20T13:29:35.120+08:00"
7    }
8  ],
9  "total_count" : 24,
10  "offset" : 4,
11  "limit" : 20,
12  "activity_id" : "10028001"
13}
14
```
 
