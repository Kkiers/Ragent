...
```
1curl -X GET \
2  https://api.mch.weixin.qq.com/v3/fund-app/mch-transfer/elecsign/transfer-bill-no/1330000071100999991182020050700019480001 \
...
23 * 微信单号查询电子回单
24 */
25public class QueryElecsignByNo {
26  private static String HOST = "https://api.mch.weixin.qq.com";
27  private static String METHOD = "GET";
28  private static String PATH = "/v3/fund-app/mch-transfer/elecsign/transfer-bill-no/{transfer_bill_no}";
29
30  public static void main(String[] args) {
31    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/v3/merchant/4013070756
32    QueryElecsignByNo client = new QueryElecsignByNo(
...
38    );
39
40    QueryElecsignByNoRequest request = new QueryElecsignByNoRequest();
...
50  }
51
52  public QueryElecsignResponse run(QueryElecsignByNoRequest request) {
53    String uri = PATH;
...
98}
99
100type QueryElecsignByNoRequest struct {
101	TransferBillNo *string `json:"transfer_bill_no,omitempty"`
102}
103
104func (o *QueryElecsignByNoRequest) MarshalJSON() ([]byte, error) {
105	type Alias QueryElecsignByNoRequest
106	a := &struct {
107		TransferBillNo *string `json:"transfer_bill_no,omitempty"`
108		*Alias
109	}{
110		// 序列化时移除非 Body 字段
111		TransferBillNo: nil,
112		Alias:          (*Alias)(o),
113	}
