...
```
1curl -X GET \
2  https://api.mch.weixin.qq.com/v3/marketing/favor/stocks/9865000/items?offset=10&limit=10&stock_creator_mchid=9865000 \
...
23 * 查询代金券可用单品
24 */
25public class ListAvailableSingleitems {
26  private static String HOST = "https://api.mch.weixin.qq.com";
27  private static String METHOD = "GET";
28  private static String PATH = "/v3/marketing/favor/stocks/{stock_id}/items";
29
30  public static void main(String[] args) {
31    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/v3/merchant/4013070756
32    ListAvailableSingleitems client = new ListAvailableSingleitems(
...
38    );
39
40    ListAvailableSingleitemsRequest request = new ListAvailableSingleitemsRequest();
41    request.stockId = "9865000";
42    request.offset = 10L;
43    request.limit = 10L;
44    request.stockCreatorMchid = "9865000";
45    try {
46      AvailableSingleitemCollection response = client.run(request);
47        // TODO: 请求成功，继续业务逻辑
...
53  }
54
55  public AvailableSingleitemCollection run(ListAvailableSingleitemsRequest request) {
56    String uri = PATH;
...
97			return nil, err
98		}
99		response := &AvailableSingleitemCollection{}
...
112}
113
114type ListAvailableSingleitemsRequest struct {
...
119}
120
121func (o *ListAvailableSingleitemsRequest) MarshalJSON() ([]byte, error) {
122	type Alias ListAvailableSingleitemsRequest
123	a := &struct {
...
138}
139
140type AvailableSingleitemCollection struct {
...
**【可用单品编码】**可用单品编码
特殊规则：单个商品编码的字符长度为【1，128】,条目个数限制为【1，100】。
