...
```
1curl -X GET \
2  https://api.mch.weixin.qq.com/v3/marketing/favor/stocks/9865000/refund-flow \
...
38    );
39
40    RefundFlowRequest request = new RefundFlowRequest();
41    request.stockId = "9865000";
42    try {
43      RefundFlowResponse response = client.run(request);
44        // TODO: 请求成功，继续业务逻辑
...
50  }
51
52  public RefundFlowResponse run(RefundFlowRequest request) {
53    String uri = PATH;
...
83			return nil, err
84		}
85		response := &RefundFlowResponse{}
...
98}
99
100type RefundFlowRequest struct {
101	StockId *string `json:"stock_id,omitempty"`
102}
103
104func (o *RefundFlowRequest) MarshalJSON() ([]byte, error) {
105	type Alias RefundFlowRequest
106	a := &struct {
...
115}
116
117type RefundFlowResponse struct {
