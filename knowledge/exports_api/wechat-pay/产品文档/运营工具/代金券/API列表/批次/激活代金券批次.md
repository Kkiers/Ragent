...
```
1curl -X POST \
2  https://api.mch.weixin.qq.com/v3/marketing/favor/stocks/9856000/start \
3  -H "Authorization: WECHATPAY2-SHA256-RSA2048 mchid=\"1900000001\",..." \
4  -H "Accept: application/json" \
5  -H "Content-Type: application/json" \
6  -d '{
7    "stock_creator_mchid" : "8956000"
8  }'
9
```
...
38    );
39
40    StartStockRequest request = new StartStockRequest();
41    request.stockId = "9856000";
42    request.stockCreatorMchid = "8956000";
43    try {
44      StartStockResponse response = client.run(request);
45        // TODO: 请求成功，继续业务逻辑
...
51  }
52
53  public StartStockResponse run(StartStockRequest request) {
54    String uri = PATH;
...
90			return nil, err
91		}
92		response := &StartStockResponse{}
...
105}
106
107type StartStockRequest struct {
108	StockCreatorMchid *string `json:"stock_creator_mchid,omitempty"`
109	StockId           *string `json:"stock_id,omitempty"`
110}
111
112func (o *StartStockRequest) MarshalJSON() ([]byte, error) {
113	type Alias StartStockRequest
114	a := &struct {
...
123}
124
125type StartStockResponse struct {
...
 start_time 　必填   string

**【生效时间】**生效时间，遵循[rfc3339标准格式](https://datatracker.ietf.org/doc/html/rfc3339)，格式为yyyy-MM-DDTHH:mm:ss.sss+TIMEZONE，yyyy-MM-DD表示年月日，T出现在字符串中，表示time元素的开头，HH:mm:ss表示时分秒，TIMEZONE表示时区（+08:00表示东八区时间，领先UTC 8小时，即北京时间）。例如：2015-05-20T13:29:35+08:00表示，北京时间2015年5月20日 13点29分35秒。
...
```
1{
2  "start_time" : "2015-05-20T13:29:35.120+08:00",
3  "stock_id" : "9865000"
4}
5
```
...
| 400 | INVALID_REQUEST | 卡包信息尚未注册完成，请稍后重试 | 稍后重试，不可以创建后马上激活 |
