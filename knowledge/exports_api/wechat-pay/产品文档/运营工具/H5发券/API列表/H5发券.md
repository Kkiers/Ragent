...
| 注意每一个H5领券域名后，都需添加#wechat_pay&wechat_redirect，否则会报错，返回268435461错误码 |  | 注意每一个H5领券域名后，都需添加#wechat_pay&wechat_redirect，否则会报错，返回268435461错误码 |
| --- | --- | --- |
|  | 注意每一个H5领券域名后，都需添加#wechat_pay&wechat_redirect，否则会报错，返回268435461错误码 |  |
...
[参与签名字段说明](https://pay.weixin.qq.com/doc/v3/merchant/4012285783#%E5%8F%82%E4%B8%8E%E7%AD%BE%E5%90%8D%E5%AD%97%E6%AE%B5%E8%AF%B4%E6%98%8E)
...
2，可用发券商户绑定的AppID获取的OpenID[获取OpenID请查看文档](https://pay.weixin.qq.com/doc/v3/merchant/4012068676)
...
建议商户调用【[根据过滤条件查询用户券](https://pay.weixin.qq.com/doc/v3/merchant/4012534963)】接口及【[查询用户单张券详情](https://pay.weixin.qq.com/doc/v3/merchant/4012535011)】接口，查询发券接口。

举例：用户领券完成并返回商家H5后，商家可自行触发刷新事件，使用【[根据过滤条件查询用户券](https://pay.weixin.qq.com/doc/v3/merchant/4012534963)】接口，通过创建商户号、批次号、OpenID，查询用户是否已成功领取指定批次券，以及领取券的具体code。
