...
| 商户未申请过证书。 | 商户未申请过API证书 | 请参考[什么是商户API证书？如何获取商户API证书？](https://pay.weixin.qq.com/doc/v3/merchant/4013053053) |
...
| HTTP头Authorization值格式错误 | 缺少 Authorization头，或其格式不正确 | 请检查上送的 Authorization，可以参考[authorization报错解决指南](https://pay.weixin.qq.com/doc/v3/merchant/4012365344) |
