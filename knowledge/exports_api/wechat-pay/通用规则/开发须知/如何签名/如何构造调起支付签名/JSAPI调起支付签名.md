...
为了方便大家理解，我们将使用测试的一对商户API证书公私钥，通过命令行形式一步一步介绍如何生成"[JSAPI调起支付](https://pay.weixin.qq.com/doc/v3/merchant/4012791857)"的签名，强烈建议你使用测试的商户API证书公私钥，按照本文实际操作一下，如果算出来的签名和文档的一致则说明计算无误。实际业务中请替换为你的真实的参数。
...
JSAPI支付需要[申请公众号](https://pay.weixin.qq.com/doc/v3/merchant/4012071573#2%E3%80%81%E7%94%B3%E8%AF%B7appid)，并获取对应的公众号的AppID，公众号的类型可以是服务号，也可以是公众号（公众号仅限于政府和媒体类型），可在[公众平台](https://mp.weixin.qq.com/)查看，参考指引[查询服务号/公众号的appid](https://pay.weixin.qq.com/doc/v3/merchant/4016328613#2.1.1%E3%80%81%E6%9C%8D%E5%8A%A1%E5%8F%B7%2F%E5%85%AC%E4%BC%97%E5%8F%B7)。
![](https://gtimg.wechatpay.cn/resource/xres/img/202409/5236a3a065efe1276d29855d7cad26f8_16x16.svg)
```
1wx2421b1c4370ec43b
```
...
[调用下单接口](https://pay.weixin.qq.com/doc/v3/merchant/4012791856)会返回prepay_id
![](https://gtimg.wechatpay.cn/resource/xres/img/202409/5236a3a065efe1276d29855d7cad26f8_16x16.svg)
```
...
| 注意：signType参数不参与签名，但需要传递，默认值为RSA，生成的签名需要通过字段paySign传递 |  | 注意：signType参数不参与签名，但需要传递，默认值为RSA，生成的签名需要通过字段paySign传递 |
| --- | --- | --- |
