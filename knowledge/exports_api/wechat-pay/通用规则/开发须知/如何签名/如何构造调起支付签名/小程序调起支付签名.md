...
为了方便大家理解，我们将使用测试的一对商户API证书公私钥，通过命令行形式一步一步介绍如何生成"[小程序调起支付](https://pay.weixin.qq.com/doc/v3/merchant/4012791898)"的签名，强烈建议你使用测试的商户API证书公私钥，按照本文实际操作一下，如果算出来的签名和文档的一致则说明计算无误。实际业务中请替换为你的真实的参数。
...
第一步，小程序支付需要[申请小程序](https://pay.weixin.qq.com/doc/v3/merchant/4012071573#2%E3%80%81%E7%94%B3%E8%AF%B7appid)，获取小程序AppID，可在[公众平台](https://mp.weixin.qq.com/)查看，参考指引[查询小程序appid](https://pay.weixin.qq.com/doc/v3/merchant/4016328613#2.1.2%E3%80%81%E5%B0%8F%E7%A8%8B%E5%BA%8F)。
![](https://gtimg.wechatpay.cn/resource/xres/img/202409/5236a3a065efe1276d29855d7cad26f8_16x16.svg)
```
1wx2421b1c4370ec43b
```
...
[调用下单接口](https://pay.weixin.qq.com/doc/v3/merchant/4012791897)会返回prepay_id
![](https://gtimg.wechatpay.cn/resource/xres/img/202409/5236a3a065efe1276d29855d7cad26f8_16x16.svg)
```
...
2(
3  {
4    "timeStamp": "1554208460",
5    "nonceStr": "593BEC0C930BF1AFEB40B4A08C8FB242",
