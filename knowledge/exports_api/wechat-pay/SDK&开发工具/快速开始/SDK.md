...
| 注意社区 SDK 由广大的微信支付开发者自发提供，我们仅提供展示的平台，不对资源的质量负责，建议大家以参考为主，不要直接拷贝使用。 |  | 注意社区 SDK 由广大的微信支付开发者自发提供，我们仅提供展示的平台，不对资源的质量负责，建议大家以参考为主，不要直接拷贝使用。 |
| --- | --- | --- |
|  | 注意社区 SDK 由广大的微信支付开发者自发提供，我们仅提供展示的平台，不对资源的质量负责，建议大家以参考为主，不要直接拷贝使用。 |  |

## 接下来阅读

- 根据你使用的编程语言，选择相应的快速上手教程：[Java](https://pay.weixin.qq.com/doc/v3/merchant/4012076506) 或 [PHP](https://pay.weixin.qq.com/doc/v3/merchant/4012076511) 或 [Go](https://pay.weixin.qq.com/doc/v3/merchant/4012076515)。
